...
| Write `docs/prds/{name}.prd.md` | Produce an implementation plan — that's `/plan` |
...
**Output path**: `docs/prds/{kebab-case-name}.prd.md`
...
```
PRD created: .docs/prds/{name}.prd.md
...
Next step: /plan .docs/prds/{name}.prd.md
